package org.wso2.carbon.identity.uma.resource.service.internal;/*
...
@Component(
        name = "org.wso2.carbon.identity.uma.resource.service.internal.AppAuthzServiceComponent",
        immediate = true
)
public class AppAuthzServiceComponent {
    ...
    protected void activate(ComponentContext ctxt) {
        ...
        log.debug("Application XACML authorization org.wso2.carbon.identity.service.xacml.handler bundle is activated");
    }
